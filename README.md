...
Detailed Report Available at : ![Report](https://drive.google.com/file/d/1JZqIV6JwNfYHioY6cD17IJW6UX_ArgAr/view?usp=sharing).
...
## 3D Simulation
The 3D Simulation and the Scientific Functions were performed using [Axisem](https://github.com/geodynamics/axisem) and [SPECFEM3D](https://github.com/SPECFEM/specfem3d) software. The output files are available at the drive link: https://drive.google.com/drive/u/1/folders/19QUjFtqC-0AK7rIrBRwY2GfpBMyvbw0f these files can be opened on PARAVIEW. 
![](/3D/topography.png)
## How to Use
